...
{
    class _10_haustiere_erweiterung
    {
        public struct Pet
        {
            public string name;
        ...
        public static void Run()
        {
            ...
            int countOfPets = 0;
            int selection = 0;
            string path = "haustiere.csv";

            pets = ReadFile(path, ref countOfPets);
            ...
            do
            {
                ...
                switch (selection)
                {
                    case 1:
                        ...
                        WriteFile(path, pets, countOfPets);
        ...
        public static Pet[] ReadFile(string path, ref int count)
        {
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                ...
                pet.name = parts[0];
                pet.owner = parts[1];
                pet.age = Convert.ToInt32(parts[2]);
                pet.type = parts[3];
                pets[i] = pet;
            }
            count = pets.Length;
        ...
        public static void WriteFile(string path, Pet[] pets, int count)
        {
            string[] lines = new string[count];
            for (int i = 0; i < count; i++)
            {
                lines[i] = pets[i].name + ";" + pets[i].owner + ";" + pets[i].age + ";" + pets[i].type;
            }
